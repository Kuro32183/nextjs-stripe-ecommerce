...
const Header: FunctionComponent = () => {
  ...
  return (
    <header className="relative bg-white">
      <nav aria-label="Top" className="max-w-7xl mx-auto sm:px-3 lg:px-8">
        <div className="relative px-4 py-4 sm:static sm:px-0 sm:pb-0">
          <div className="h-16 flex items-center justify-between">
            {/* Logo */}
            <div className="flex-1 flex text-[1.5rem] lg:text-[2rem] font-[900] tracking-tight md:tracking-wide lg:tracking-wider">
              <a href="#">
                Vintage <span className="text-indigo-600 ">Microphone</span>{" "}
                Shop !!
              </a>
            </div>
